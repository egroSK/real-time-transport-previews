...
app.get('/', function (req, res) {
	...
	res.render('index.ejs', { 'title': 'LONG-POLLING <script> ELEMENT - Jednoduchý TODO list' });
});
...
app.post('/todo', function (req, res) {
	...
	while (resp = responses_tmp.pop()) {
		resp.send('processData('+ json_to_send + ');');
	}
});

/**
 * GET /todos (param = since)
 * Uloži objekt s požiadavkou do pola požiadaviek
 */
